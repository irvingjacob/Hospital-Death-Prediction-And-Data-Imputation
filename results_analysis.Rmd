...
```{r fig3, fig.align = 'center', fig.width = 6, fig.height = 6, echo=FALSE}
# Create ROC curves for each model (on test data)
#lasso_mice_guess <- ifelse(LASSO_MICE_PRED[,2] > 0.24, "1", "0")


# roc_LASSO_MICE <- roc(mice.test$hospital_death, LASSO_MICE_PRED)
